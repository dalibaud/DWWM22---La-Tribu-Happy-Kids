...
<body>
  <div class="section-wrapper">
    ...
    <header class="main-header sticky-top top-0 start-0 w-100 transition-300 d-flex align-items-center">
      <nav class=" navbar-expand-lg navbar-light col-11 mx-auto position-relative">
        ...
        <div class="menu-wrapper w-100 position-relative d-flex justify-content-between align-items-center white">
          <!-- Main logo  -->
          ...
          <div class="connect-box d-flex flex-row align-items-center my-2 my-lg-0">
            ...
            <div>
              <a href="index.php?action=connection" class="connexion-link fsize-20 me-20 ms-2 my-sm-0 ">
                <b>Se connecter</b>
              </a>
            </div>
          </div>
  ...
  <!-- Scroll-to-top  -->
  <a href="#" class="to-top position-fixed bottom-50 end-50 bradius-50-percent
   z-200 d-flex align-items-center justify-content-center fsize-40 transition-400 intensePurple bg-white">
