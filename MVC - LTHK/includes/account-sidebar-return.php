			...
			<div class=" col-10 col-lg-3 mx-auto" data-aos="fade-up" data-aos-delay="100" data-aos-duration="500">
				<div class="account-sidebar">
					<!-- Bouton de retour à l'espace client  -->
					<div class="account-sidebar__welcome__return fs-4 mt-4 mx-auto border-all py-10 px-20 bradius-10 text-center position-relative">
						<a href="index.php?action=account" class="peach ps-20 transition-500">
							Retour en arrière
						</a>
					</div>
